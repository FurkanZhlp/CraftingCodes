            ...
            @auth
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('profile',Auth::user()->username)}}"><i
                                class="dripicons-user text-muted mr-2"></i> Profil</a>
                        <a class="dropdown-item" href="#"><i class="dripicons-gear text-muted mr-2"></i> Ayarlarım</a>
                        <a class="dropdown-item text-danger" href="{{route('admin')}}"><i
                                class="dripicons-lock text-muted mr-2"></i> Yönetim Paneli</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{route('logout')}}"><i
                                class="dripicons-exit text-muted mr-2"></i> Çıkış Yap</a>
                    </div>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('login')}}"><i
                                class="dripicons-user text-muted mr-2"></i> Giriş Yap</a>
                        <a class="dropdown-item" href="{{route('register')}}"><i
                                class="dripicons-wallet text-muted mr-2"></i> Kayıt Ol</a>
                    </div>
                </li><!--end dropdown-->
            @endauth
            <li class="menu-item">
                ...
                <ul class="navigation-menu d-flex justify-content-center">
                    ...
                    <li class="mcs-nav-item">
                        <a href="#">
                            <svg class="nav-svg" viewBox="0 0 512 512">
                                <path
                                    d="M352 144v-39.6C352 82 334 64 311.6 64H200.4C178 64 160 82 160 104.4V144H48v263.6C48 430 66 448 88.4 448h335.2c22.4 0 40.4-18 40.4-40.4V144H352zm-40 0H200v-40h112v40z"></path>
                            </svg>
                            <span>Ekipler</span>
                        </a>
                    </li>
